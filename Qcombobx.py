...
class Ui_Form(object):
    def rmitem(self):
        indx=self.cb1.currentIndex()
        itm=self.cb1.currentText()
        self.t2.setText(itm+"is removed from combobox")
        self.cb1.removeItem(indx)
    def additem(self):
        self.cb1.addItem(self.t1.text())
        self.t2.setText(self.t1.text()+"added to combobox")        
